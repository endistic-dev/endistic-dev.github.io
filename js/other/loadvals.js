...
function copy_build(setting) {
  ...
  if (setting.includes("copy")) {
    copyToClipboard("https://endistic-dev.github.io/builder/index.html?v=4&b=" + encoded);

    // Alert the copied text
    alert("Copied build link!");
  } else {
    try {
      window.history.replaceState(null, document.title, "https://endistic-dev.github.io/builder/index.html?v=4&b=" + encoded)
    } catch (error) {
